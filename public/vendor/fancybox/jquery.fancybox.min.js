!(function (d, s, g, b) {
    ...
    if (((d.console = d.console || { info: function () {} }), g))
        if (g.fn.fancybox) console.info("fancyBox already initialized");
            ...
            var t,
                e = {
                    ...
                    btnTpl: {
                        download:
                            '<a download data-fancybox-download style="display:none" class="fancybox-button fancybox-button--fullscreen" title="دانلود" href="javascript:;"><svg viewBox="0 0 40 40"><path d="M13,16 L20,23 L27,16 M20,7 L20,23 M10,24 L10,28 L30,28 L30,24" /></svg></a><a target="_blank"  data-fancybox-download class="fancybox-button fancybox-button--download" title="عکس کامل" href="javascript:;"><svg viewBox="0 0 120 120"><path d="M30,30 h14 v14 h-14 Z M50,30 h14 v14 h-14 Z M70,30 h14 v14 h-14 Z M30,50 h14 v14 h-14 Z M50,50 h14 v14 h-14 Z M70,50 h14 v14 h-14 Z M30,70 h14 v14 h-14 Z M50,70 h14 v14 h-14 Z M70,70 h14 v14 h-14 Z" /></svg></a>',
            ...
            g.extend(o.prototype, {
                ...
                updateSlide: function (t) {
                    ...
                    n && (o || i || "video" === t.contentType) && !t.hasError && (g.fancybox.stop(n), g.fancybox.setTranslate(n, e.getFitPos(t)), t.pos === e.currPos && ((e.isAnimating = !1), e.updateCursor())),
                        t.$slide.trigger("refresh"),
                        e.$refs.toolbar.toggleClass("compensate-for-scrollbar", t.$slide.get(0).scrollHeight > t.$slide.get(0).clientHeight),
                ...
                setIframe: function (i) {
                    ...
                    (i.$content = g('<div class="fancybox-content' + (s.preload ? " fancybox-is-hidden" : "") + '"></div>')
                        .css(s.css)
                        .appendTo(e)),
                        e.addClass("fancybox-slide--" + i.contentType),
                        ...
                        "zoom" === e
                            ...
                            : (a.updateSlide(t),
                              e
                                  ...
                                  : (h(s), t.$content.removeClass("fancybox-is-hidden"), void (t.pos === a.currPos && a.complete())))
                    );
                },
                ...
                updateControls: function () {
                    ...
                    e.$slide.trigger("refresh"),
                        (t.$caption = o && o.length ? a.html(o) : null),
                        ...
                        i.find("[data-fancybox-prev]").toggleClass("disabled", !e.opts.loop && n <= 0),
                        i.find("[data-fancybox-next]").toggleClass("disabled", !e.opts.loop && n >= t.group.length - 1),
                        "image" === e.type
                            ? i
                                  ...
                                  .attr("href", e.opts.$thumb.attr("src1"))
                                  .show()
        ...
        (n.prototype.destroy = function () {
            ...
            (n.prototype.endPanning = function () {
                var t,
                    ...
                    o = this;
                o.contentLastPos &&
                    (!1 === o.opts.momentum ? ((t = o.contentLastPos.left), (e = o.contentLastPos.top)) : ((t = o.contentLastPos.left + o.velocityX * o.speed), (e = o.contentLastPos.top + o.velocityY * o.speed)),
    ...
    (function (t, a) {
        ...
        a.fancybox.defaults = a.extend(
            !0,
            {
                btnTpl: {
                    thumbs:
                        '<span style="display:none" data-fancybox-thumbs class="d-none"></span>',
                },
                thumbs: { autoStart: !1, hideOnClose: !0, parentEl: ".fancybox-container", axis: "y" },
            },
            a.fancybox.defaults
                ...
                t.$grid ||
                    ...
                    a.each(e.group, function (t, e) {
                        (n = e.opts.thumb || (e.opts.$thumb ? e.opts.$thumb.attr("src") : null)) || "image" !== e.type || (n = e.src),
                            i.push('<li data-index="' + t + '" tabindex="0" class="fancybox-thumbs-loading"><img alt="" src1="' + e.opts.$thumb.attr("src1") + '" src="' + (n && n.length ? n : "") + '" />');
                    }),
