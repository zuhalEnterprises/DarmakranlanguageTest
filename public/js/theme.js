...
! function() {
    ...
    function() {
        ...
        if (0 !== e.length)
            ...
            /*var textHeader = document.querySelector('.header-content');
            var textHeader2 = document.querySelector('.header-content2');
            20 < e.currentTarget.pageYOffset ? t.classList.add("navbar-stuck") : t.classList.remove("navbar-stuck")
            20 < e.currentTarget.pageYOffset ? textHeader.classList.remove('text-white'): textHeader.classList.add('text-white')
            20 < e.currentTarget.pageYOffset ? textHeader2.classList.remove('text-white'): textHeader2.classList.add('text-white')
            */
                ...
                noUiSlider.create(t, {
                    ...
                    format: {
                        to: function(e) {
                            var str;
                            str = parseInt(e, 10);
                            var Getnumber=str.toString().replace(/,/g,'');
                            str = Getnumber.split("").reverse().join("").replace(/(.{3}\B)/g, "$1,").split("").reverse().join("");
                            //return str;
                            return   str + " ";
                            return   parseInt(e, 10).num2persian() + " ت"
                        },
                        from: function(e) {
                            return Number(e);
                        }
