...
class ImageKoomeh extends Model
{
    /**
     * تصاویر ملک
     *
     ...
     * @var array
     */
    protected $fillable = ['estate_id','user_id', 'name', 'token', 'extension', 'url', 'dimension', 'cover','is_360','month' , 'year'];
