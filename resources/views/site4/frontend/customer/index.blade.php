                ...
                <div class="card shadow-sm">
                    ...
                    <div class=" card-body border-0  pb-1 me-lg-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 col-md-6 col-lg-3 col-sm-12 mt-3 usage_type1">
                            ...
                            <div class="col-6 col-md-6 col-lg-3 col-sm-12 mt-3">
                                <label class="form-label" for="country">{{l('کشور')}}</label>
                            ...
                            <div class="col-6 col-md-6 col-lg-3 col-sm-12 mt-3">
                                <label class="form-label" for="language">{{l('زبان')}}</label>
                                <select class="form-control" name="language" id="language" style="width:100%">
                                    <option value=""></option>
                            ...
                            <div class="col-6 col-md-6 col-lg-6 col-sm-12 mt-3">
                            ...
                            <div class="col-12 col-md-6 col-lg-6 col-sm-12 mt-3 district">
                            ...
                            <div class="col-md-6 col-lg-3 d-none col-sm-12 mt-3 rent" >
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6 col-md-6 col-lg-3 col-sm-12 mt-3">
                                                ...
                                                <select class="form-control" name="label" id="label">
                                                    ...
                                                    <option value="1" >{{l('برنزی')}}</option>
                                                    <option value="2" >{{l('نقره ای')}}</option>
                                                    <option value="3" >{{l('طلایی')}}</option>
                                                    <option value="4" >{{l('الماس')}}</option>
                                                </select>
                                            </div>
                                            <div class="col-6 col-md-6 col-lg-3 col-sm-12 mt-3">
                                                <label class="form-label" class="required">{{l('دلیل خرید')}}</label>
                                            ...
                                            <div class="col-md-6 col-lg-3 col-sm-12 mt-5 form-check form-switch">
