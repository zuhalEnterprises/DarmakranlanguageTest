...
<div class="col-sm-12 col-md-6 col-lg-6 mb-4 main">
	...
	c0,0,0,0,0.001,0c3.72,0,7.188-1.581,10.305-4.698l2.537-2.537C54.033,45.163,54.383,42.833,53.364,40.908z" />
                    ...
                    <!--a href="https://api.whatsapp.com/send?text=سلام {{!empty($estate->expert)?($estate->expert->title??$estate->expert->fullname()):$estate->owner_name}} عزیز من این ملک را در سایت {{ss('SITE_NAME')}} دیدم. خوشحال میشم تا اطلاعات بیشتری در مورد این ملک به من بدید ekama.ir/v/{{$estate->id}}/{{$estate->link_rewrite()}} &phone=+98{{substr(!empty($estate->expert)?$estate->expert->username:$estate->phone,1)}}" class="radius-20 font_9" data-toggle="tooltip" title="{{ l('ارتباط با کارشناس در واتساپ') }}">
