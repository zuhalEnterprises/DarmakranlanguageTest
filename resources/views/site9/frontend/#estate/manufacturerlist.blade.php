        ...
        <tr id="{{$item->id}}">
            ...
            <td valign="middle" align="center">
                ...
                <ul class="dropdown-menu my-1" aria-labelledby="contextMenu2">
                    <li>
                        <a class="dropdown-item"  href="/profile/manufacturer/edit/{{$item->id}}">
                    ...
                    <li>
                        <a class="dropdown-item"  href="/profile/project?manufacturer_id={{$item->id}}">
                            <i class="fa-light fa-edit opacity-60 me-2"></i> {{l('لیست پروژه ها')}}
                        </a>
                    </li>
                </ul>
            </td>
