...
<head>
    ...
    <link rel="stylesheet" media="screen" href="/css/{{ss('CSSTHEME')}}.min.css">
...
<body  dir="rtl" class="@yield('body_class')">
    ...
    <a class="btn-scroll-top" href="#top" data-scroll><span
        class="btn-scroll-top-tooltip text-muted fs-sm me-2">{{l('TOP')}}</span><i
        ...
        function addFavorite(id){
           $.get("/estates/favorite/" + id, function (data, status) {
               if (data.result == 1) {
                   toast({
                       type: 'success',
                       text: 'Added to the favorite List'
                   });
                   ...
                   $(".itemFavorite-" + id).removeClass("favorited");
               }
           });
       }
    </script>
