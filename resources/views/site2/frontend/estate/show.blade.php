...
@section('main_content')
    ...
    <main class="page-wrapper">
        ...
        <section class="container mt-6 mb-lg-5 mb-4 pt-5 pb-lg-5">
            <!-- Breadcrumb-->
            ...
            <div class="row gy-5 pt-lg-2">
                <div class="col-lg-7">
                            ...
                            <div class="order-lg-1 order-2">
                                <div class="tns-carousel-wrapper">
                                    ...
                                    <div class="tns-carousel-inner"
                                        ...
                                        <a href="/upload/images/estate/{{ $url->url() }}" class="fancybox.image"  data-fancybox-group="thumb" data-fancybox="gallery">
                    ...
                    <p class="mb-4 fs-5 fw-bold">
                        ...
                        آدرس:
                        {{ !empty($estate->city) ? $estate->city->name : '' }}
                    ...
                    <div class="ps-lg-5">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <div>
                                ...
                                <span class="badge bg-info me-2 mb-2">{{confirmStatuses($estate->confirmation)}}</span>
                ...
                <div class="card-body ">
                        <div class="d-flex align-items-center gap-3 mb-3">
                            ...
                            <a class="text-decoration-none" href="/">
                                <img class="rounded-circle mb-2" src="/img/site2/logo.png" width="80" height="80" alt="">
                            </a>
                            <div>
                                <h5 class="mb-1">
        ...
        @endif
        @if (!empty($estateRent) && count($estateRent)>0)
        <section class="container my-5">
            <div class="d-sm-flex align-items-center justify-content-between mb-4 pb-2">
                <h2 class="h4 mb-sm-0 font-vazir">{{ l('اجاره روانه ویلا و اقامتگاه') }}</h2>
                <!--a class="btn btn-link fw-normal ms-sm-3 p-0" href="city-guide-catalog.html">{{ l('مشاهده همه') }}<i class="fi-arrow-long-left ms-2"></i></a-->
            </div>
                    ...
                    <div>
                        <div class="position-relative">
                            <div class="position-relative mb-3">
                                ...
                                <img class="rounded-3" src="{{$estate->coverImage()}}" alt="اجاره روزانه {{ estateTypes($estate->estate_type) }} در {{($estate->city->name ?? '')}}">
                            </div>
            ...
            <div class="modal-body px-sm-5 px-4">
                ...
                <label class="form-label" for="customer_id">{{ l('نام مشتری') }}</label>
                    <select class="form-control  form-select w-100 select2 customer_id" id="customer_id"  style="width: 100%!important;height:40px!important" name="customer_id">
                        <option value="" >{{ l('بدون همراهی با مشتری') }}</option>
                        @if($customers)
...
<div class="modal fade" id="modal-relation" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body px-sm-5 px-4">
                <div class="mb-3 " id="customer_id2">
...
@section('js')
    ...
    <script>
        ...
        {
            estate_id = {{ $estate->id }};
            customer_id = $('.customer_id2').val();
            //alert( $('.customer_id2').val());
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': '{{csrf_token()}}'
                }
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    var operation = res.operation_id;
                    $('.customer_id2').val('');
                    $('#modal-relation').modal('toggle');
                    swal({
                        title: l("ملک با موفقیت اضافه گردید"),
                        message: "",
                        confirmButtonColor: '#025EC6',
                        confirmButtonText: l('باشه'),
                        type: "success",
