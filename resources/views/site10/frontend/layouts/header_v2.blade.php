...
<header class="navbar navbar-expand-lg navbar-light  fixed-top pt-lg-0 flex-column pt-1" style="background: #fff">
        ...
        <div class="container">
            <div class="d-flex align-items-center justify-content-between gap-2">
                <div class="d-flex gap-5">
                    <a href="mailto:{{ss('SITE_EMAIL')}}" class="text-gold d-flex gap-2 align-items-center fs-sm">
                        <span>  {{ss('SITE_EMAIL')}} </span>
                        <span><i class="fi-mail"></i></span>
                    </a>
                </div>
                <div class="nav flex-row gap-3 align-items-center">

                    <a href="tel:{{ss('SITE_PHONE')}}" class="text-gold nav-link p-0 fw-normal opacity-80 me-3" style="direction:ltr">
                        {{ss('SITE_PHONE')}}
    ...
    <div class="container gap-1 pt-0 pb-0 border-bottom containerheader" style="margin-top: 0 !important;">
        ...
        <a href="/" class="me-2">
            <img src="/img/site10/logo.jpg" style="height:50px;margin-bottom:12px" alt="{{ss('SITE_NAME')}}">
        </a>
