            ...
            <div class="row">
                ...
                @endif
                    <div class="row">
                        ...
                        <section class="card card-body shadow-sm p-2 mb-4" id="basic-info">
                        ...
                        <!-- Price-->
                        <section class="card card-body shadow-sm p-2 mb-4" id="price">
                        ...
                        <section class="card card-body shadow-sm p-2 mb-4" id="location">
                        ...
                        <section class="card card-body shadow-sm p-2 mb-4" id="details">
                            ...
                            <section class="card card-body shadow-sm p-2 mt-4" id="photos">
                                <h2 class="h5">
