<div class="card card-hover border-1 h-100 rounded rounded-md-3 ">
    <div class="tns-carousel-wrapper card-img-top card-img-hover">
        ...
        <div class="position-absolute end-0 bottom-0 pt-3 ps-3 m-1">
            <button class="d-table btn btn-sm px-4 py-1 rounded-pill fw-semibold" onclick="return agreement({{$estate->id}})" style="background-color: #f5f5f5; color: #444; font-size: 0.85rem; border: 1px solid #ccc;" >
                <i class="fi-calendar mt-n1 me-2 align-middle opacity-70"></i>
                {{ l('درخواست بازدید') }}
            </button>
        </div>
