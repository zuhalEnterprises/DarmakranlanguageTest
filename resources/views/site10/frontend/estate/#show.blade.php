                                ...
                                <div class="tns-carousel-wrapper">
                                    ...
                                    <div class="tns-carousel-inner"
                                        ...
                                        <a href="{{getDomainImg($url->id)}}/upload/images/estate/{{ $url->url() }}" class="fancybox.image"  data-fancybox-group="thumb" data-fancybox="gallery">
                                            <div class="rounded-3" style="background-image: url('{{getDomainImg($url->id) != 'https://file.cafooproperties.com' ? crop('/upload/images/estate/'.$url->url(),850,850) : getDomainImg($url->id).'/upload/images/estate/'.$url->url() }}')"></div>
                                        </a>
                                        @endforeach
                                ...
                                <ul class="tns-thumbnails" id="thumbnails">
                                    @foreach ($images->where("360","=",0)->where("plan","=",0)->where("hidden","=",0) as $url)
                                        <li class="tns-thumbnail" >
                                                <img alt="{{ $estate->title }}" src="{{getDomainImg($url->id) != 'https://file.cafooproperties.com' ? crop('/upload/images/estate/'.$url->url() , 200 , 200): getDomainImg($url->id).'/upload/images/estate/'.$url->url()}}" class="pic-estate-small">
                                        </li>
                                    @endforeach
