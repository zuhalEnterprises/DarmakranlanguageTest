...
'title' => (!empty($model)? l('ویرایش برند') :l('ثبت برند')),
])
            ...
            <div class="col-lg-9 col-md-12 mb-5 account add-property">
                ...
                <nav class="mb-4 pt-md-3" aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{!empty($model)? l('ویرایش برند') :l('ثبت برند')}}</li>
                    </ol>
                </nav>
                <form method="post" id="js_singup" action="{{empty($model)?"/profile/brand/store":"/profile/brand/update/".$model->id}}">
                    @csrf
                    @method('post')
                <!-- Page content-->
                <div class="mb-4">
                    <h1 class="h2">{{!empty($model)? l('ویرایش برند') :l('ثبت برند')}}</h1>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div>
                            <button type="submit" class="btn btn-primary">
                                ...
                                {{!empty($model)? l('ویرایش برند') :l('ثبت برند')}}
                            </button>
                        </div>
                     </div>
                </div>
