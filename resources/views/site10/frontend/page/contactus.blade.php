...
<br><br>
{{l('شماره تماس :')}} {{ss('SITE_PHONE')}}




<br><br>
{{l('آدرس صفحات ما :')}} {{ss('INSTAGRAM')}}
          ...
          <section class="container mb-5 pb-2 pb-md-4 pb-lg-5">
            <div class="row g-4">
              <!-- Item-->
              <div class="col-md-4"><a class="icon-box card card-hover h-100" href="mailto:{{ss('SITE_EMAIL')}}">
                  <div class="card-body">
                    ...
                    <h3 class="h5 icon-box-title mb-0 opacity-90">{{ss('SITE_EMAIL')}}</h3>
                  </div></a></div>
              <!-- Item-->
              <div class="col-md-4"><a class="icon-box card card-hover h-100" href="tel:{{ss('SITE_PHONE')}}">
                  <div class="card-body">
                    ...
                    <h3 class="h5 icon-box-title mb-0 opacity-90 ltr">{{ss('SITE_PHONE')}}</h3>
                  </div></a></div>
              <!-- Item-->
              <div class="col-md-4"><a class="icon-box card card-hover h-100" href="#">
                  <div class="card-body">
                    ...
                    <h3 class="h5 icon-box-title mb-0 opacity-90 ltr">{{ss('INSTAGRAM')}}</h3>
                  </div></a></div>
            </div>
          </section>
    </main>
