...
<script type="application/ld+json">
    ...
    "@context":"https://schema.org","@graph":[
        {
            "@type":"Place",
            "@id":"https://cafooproperties.com/#place",
        ...
        {
            "@type":"Organization",
            "@id":"https://cafooproperties.com/#organization",
                "name":"{{json_encode(l('املاک کفو'))}}",
                "url":"https://cafooproperties.com",
                "sameAs":
                [
                    "https://www.instagram.com/cafooproperties.amlak"
                ],
                ...
                "address":{
                    ...
                    "logo":{
                        "@type":"ImageObject",
                        "@id":"https://cafooproperties.com/#logo",
                        "url":"https://cafooproperties.com/img/site3/logo-b.jpg",
                        "contentUrl":"https://cafooproperties.com/img/site3/logo-b.jpg",
                        "caption":"{{json_encode(l('املاک کفو'))}}",
                        "inLanguage":"fa-IR",
                        "width":"200",
                        "height":"200"
                    },
                    ...
                    {
                        "@type":"WebSite",
                        "@id":"https://cafooproperties.com/#website",
                        "url":"https://cafooproperties.com",
                        "name":"{{json_encode(l('املاک کفو'))}}",
                        "publisher":
                        {
                    ...
                    @endif
                    {
                        ...
                        "isPartOf":{"@id":"https://cafooproperties.com/#website"},
                        @if($model->img() != '')
                        "primaryImageOfPage":
                        {
                            "@id":"{{$model->img()}}"
...

                    {
                        ...
                        "datePublished":"{{$model->created_at}}+03:30",
                        "dateModified":"{{$model->updated_at}}+03:30",
                        "publisher":{"@id":"https://cafooproperties.com/#organization"
                    },
