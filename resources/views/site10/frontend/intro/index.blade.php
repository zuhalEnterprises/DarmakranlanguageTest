...
'title' => ss('SITE_NAME'),
'canonical' => 'https://cafooproperties.com'
])
...
<main class="page-wrapper">
    ...
    <section class="container-fluid px-0">
        <div class="jarallax card align-items-center  justify-content-md-center border-0 p-md-5 p-4 bg-secondary mt-n3 height-hero" style="border-radius:unset; " data-jarallax data-speed="0.5">
            ...
            <video class="videomobile " autoplay="" muted="" loop="" width="320" height="190">
                <source src="/img/site10/{{rand(1,2)}}.mp4" type="video/mp4">
            </video>
            @else
            ...
            <div class="content-overlay" style="max-width: 856px;">
                <h1 class="display-5 mt-md-5 pt-md-5  text-white text-center">
                    ...
                    {{l('انتخاب هوشمندانه، خرید لذت بخش')}}
                </h1>
    ...
    <section class="container  pb-4 pt-3" >
                ...
                <div class="d-flex flex-column flex-lg-row gap-4 justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center gap-4">
                        <div class="text-white">
                            ...
                            <a class="text-white text-decoration-none fs-6" href="tel:00971503491050">971503491050+ </a>
                            &nbsp;
    ...
    <section>
        <div class="container">
            <div class=" mb-5 mt-n3 mt-lg-0 py-5">
                <h3 class="fs-2 text-center">{{l('چرا کفو برای شما انتخاب خوبی است؟')}}</h3>
                <p class="fs-lg text-justify text-lg-center">
                    {{l('املاک کَفو یک بنگاه معاملات ملکی در دبی است که به‌طور تخصصی خدمات خرید، فروش و اجاره ملک را به سرمایه‌گذاران ایرانی ارائه می‌دهد. با آشنایی کامل با بازار املاک امارات، املاک کفو مسیر مطمئنی برای سرمایه‌گذاری، خرید خانه و دریافت اقامت در دبی فراهم می‌کند.')}}
                </p>
            </div>
        </div>
    </section>
        ...
        <div class="overflow-hidden rounded-3  bg-secondary g-0 row flex-column-reverse flex-lg-row align-items-center">
            <div class="col-12 col-lg-6 p-0">
                <div class="mx-5 py-3">
                    ...
                    <p class="fs-6 mb-3 text-justify">{{l('هر کجای کشور امارات که ملکی برای فروش دارید می تونید با چند کلیک ساده ملکتان را به صورت رایگان در کفو آگهی و در سریع ترین زمان ممکن معامله کنید')}}</p>
    ...
    <section class="container pb-md-4">
        <div class="d-flex align-items-center justify-content-center mb-3">
            <h2 class="h3 mb-4 mt-4 mt-lg-0"> {{l('کارشناسان کفو')}}</h2>
        ...
        <div class="accordion qaa  to-expand" id="accordionExample">
            ...
            <div class="accordion-item">
                ...
                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse15" aria-expanded="true" aria-controls="collapseOne">
                    {{l('6. چرا باید از مشاوران املاک کفو کمک بگیرم؟')}}
                </button>
                </h2>
            ...
            <div class="accordion-item">
                <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
                    {{ l('15. آیا کفو فقط در دبی فعالیت می‌کند یا در سایر امارات هم خدمات دارد؟') }}
            ...
            <div class="accordion-item">
                <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
                    {{ l('16. آیا کفو خدمات پس از خرید هم ارائه می‌دهد؟') }}

                </button>
                </h2>
                <div id="collapse6" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body text-justify">
                        {{ l('بله. ما در کفو خدماتی مانند مدیریت ملک، اجاره دادن، نظارت بر تعمیرات و تمدید اقامت را نیز به مشتریان عزیز ارائه می‌دهیم.') }}
                    </div>
                </div>
            </div>
            <div class="accordion-item">
                <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
                    {{ l('17. چگونه می‌توانم با کارشناسان کفو مشاوره رایگان داشته باشم؟') }}
                </button>
                </h2>
                <div id="collapse6" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body text-justify">
            ...
            <div class="accordion-item">
                <h2 class="accordion-header">
                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse6" aria-expanded="false" aria-controls="collapse6">
                    {{ l('18. کفو چه نوع املاکی را ارائه می‌دهد؟') }}
                </button>
                </h2>
                <div id="collapse6" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body text-justify">
                        {{ l('کفو در زمینه فروش آپارتمان‌، ویلا، واحدهای لوکس، املاک تجاری، پیش‌فروش و پروژه‌های در حال ساخت در مناطق مختلف دبی فعالیت دارد.') }}
                    </div>
                </div>
            </div>
