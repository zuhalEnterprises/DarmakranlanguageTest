@extends(ss('THEME').'.frontend.layouts.intro.appnew_v2',['title'=>'404'])
        ...
        <div class="row align-items-md-center gy-4">
          <div class="col-lg-4 order-lg-1 order-2 position-relative py-lg-0 py-5 text-lg-end text-center">
            ...
            <div class="position-relative zindex-5">
              <h1 class="display-6  text-light">{{ l('صفحه موردنظر یافت نشد!') }}</h1>
              <p class="mb-lg-4 mb-3 pb-lg-3 fs-lg text-light opacity-70">{{ l('با عرض پوزش، ما نمی توانیم صفحه مورد نظر شما را پیدا کنیم. پیشنهاد می کنیم در حین رفع مشکل به صفحه اصلی بروید.') }}</p>
              ...
              <div class="pt-3">
                <a class="btn btn-lg btn-primary w-sm-auto w-100 mb-3 me-sm-4" href="/home">{{ l('صفحه اصلی') }}</a>
          ...
          <div class="col-lg-6 offset-lg-2 order-lg-2 order-1">
            <div class="ratio ratio-1x1 mx-auto" style="max-width: 636px;">
              <lottie-player src="/img/animation-real-estate-404.json" background="transparent.html" speed="1" loop autoplay></lottie-player>
            </div>
          </div>
        </div>
      </div>
