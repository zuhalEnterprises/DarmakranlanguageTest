...
<script type="application/ld+json">
    ...
    "@context":"https://schema.org","@graph":[
        ...
        {
            "@type":"Organization",
            "@id":"https://cafoo.ae/#organization",
                "name":"{{json_encode(l('املاک دارمکران'))}}",
                "url":"https://cafoo.ae",
                "sameAs":
                [
                ...
                "address":{
                    ...
                    "logo":{
                        "@type":"ImageObject",
                        "@id":"https://cafoo.ae/#logo",
                        "url":"https://cafoo.ae/img/site3/logo-b.jpg",
                        "contentUrl":"https://cafoo.ae/img/site3/logo-b.jpg",
                        "caption":"{{json_encode(l('املاک دارمکران'))}}",
                        "inLanguage":"fa-IR",
                        "width":"200",
                        "height":"200"
                    },
                    ...
                    @endif
                    {
                        ...
                        "isPartOf":{"@id":"https://cafoo.ae/#website"},
                        @if($model->img() != '')
                        "primaryImageOfPage":
                        {
                            "@id":"{{$model->img()}}"
...

                    {
                        ...
                        "datePublished":"{{$model->created_at}}+03:30",
                        "dateModified":"{{$model->updated_at}}+03:30",
                        "publisher":{"@id":"https://cafoo.ae/#organization"
                    },
