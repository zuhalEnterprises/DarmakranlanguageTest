<!DOCTYPE html>
<html lang="{{ $currentLocale }}" @if(in_array($currentLocale, ['fa', 'ar'])) dir="rtl" @else dir="ltr" @endif>
...
<head>
    ...
    <meta name="language" content="{{ strtoupper($currentLocale) }}">
    ...
    <meta property="og:locale" content="{{ $currentLocale }}_{{ strtoupper($currentLocale) }}" />
    ...
    @if(in_array($currentLocale, ['fa', 'ar']))
