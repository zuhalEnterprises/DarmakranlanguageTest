...
<main class="page-wrapper">
        ...
        <div class="card card-body rounded" style="max-width: 940px">
            ...
            <div class="row mx-0 align-items-center">
                <div class="col-md-6 border-end-md p-4 p-sm-5">
                    <h2 class="h3 mb-4 mb-sm-5">{{ l('سلام!') }}<br>{{ l('به سایت دارمکران خوش آمدید.') }}</h2>
                    <img class="d-block mx-auto rotate-img" src="/img/signin-modal/signin.svg" width="344" alt="Illustartion">
				    <div class="mt-4 mt-sm-5">
                        {{ l('هنوز ثبت نام نکرده اید؟') }}
                        <a href="/register">{{ l('ثبت نام') }}</a>
                    </div>
                </div>
                <div class="col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5">
                    ...
                    <form class="needs-validation" novalidate method="POST" action="{{ route('login2') }}">
                        ...
                        <div class="mb-4">
                            <label class="form-label mb-2" for="signin-email">{{ l('پست الکترونیکی') }}</label>
                            <input class="form-control" type="email" id="username" name="username" placeholder="{{ l('ایمیل') }}" required>
                        </div>
                        <div class="mb-4">
                            <div class="d-flex align-items-center justify-content-between mb-2">
                                <label class="form-label mb-0" for="signin-password">{{ l('رمز عبور') }}</label>
                                <a class="fs-sm" href="/forgot-password">{{ l('رمز عبور را فراموش کرده اید؟') }}</a>
                            </div>
                            <div class="password-toggle">
                                <input class="form-control" type="password" id="password" name="password" placeholder="{{ l('رمز عبور را وارد نمایید') }}" required>
                                <label class="password-toggle-btn" aria-label="Show/hide password">
                                <input class="password-toggle-check" type="checkbox"><span class="password-toggle-indicator"></span>
                                </label>
                            </div>
                        </div>
                        <button class="btn btn-primary btn-lg w-100" type="submit">{{ l('ورود به حساب کاربری') }}</button>
                  </form>
                </div>
            </div>
        </div>
        <div class="card card-body mt-5 rounded d-none" style="max-width: 940px">
            <div class="row mx-0 align-items-center">
                <div class="col-md-6 d-none d-md-block">
                    <div class="h-100 w-100" style="background: url('/img/site10/agreement.jpg') center center / cover no-repeat;"></div>
                </div>
                ...
                <div class="col-md-6 p-4">
                    ...
                    <a href="{{ url('/auth/google') }}" class="btn btn-danger w-100">
                        <i class="fab fa-google me-2"></i> {{ l('ورود با حساب گوگل') }}
                    </a>
                    <div id="frm-register" class="form-horizontal">
                        {{-- step login --}}
                        <div class="step-login">
                            <div class="col-xs-12 form-control-lg input-group-sm mb-3">
                                <label class="form-label form-login-label">{{l('لطفا نام کاربری را وارد کنید')}}</label>
    ...
    <section class="d-none container-fluid my-5 pt-5 pb-lg-4 px-xxl-4">
        <div class="row">
