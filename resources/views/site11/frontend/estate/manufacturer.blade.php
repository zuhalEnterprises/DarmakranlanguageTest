            ...
            <div class="col-lg-9 col-md-12 mb-5 account add-property">
                ...
                <nav class="mb-4 pt-md-3" aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{l('لیست سازندگان')}}</li>
                    </ol>
                </nav>
                <!-- Page content-->
                <div class="mb-4 d-flex align-items-center justify-content-between">
                    <h1 class="h2">{{l('لیست سازندگان')}}</h1>
                    <a href="/profile/manufacturer/create" class="btn btn-primary" >
...
function deleteTodoItem(id) {
    ...
    //alert(id);
    $.get("/profile/manufacturer/destroy/"+id, function (data, status) {
        if (data.result)
        {
            swal({
