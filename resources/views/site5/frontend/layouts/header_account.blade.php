...
<header class="navbar navbar-expand-lg navbar-light bg-light fixed-top shadow-lg flex-column py-0" data-scroll-header>
    ...
    <div class="container py-2">
        ...
        <a href="/" class="me-2">
            <img src="/img/site3/logo-sha.webp" style="height: 50px">
        </a>
        <a href="/" class="navbar-brand ms-auto ms-xl-4 logo " >
            <span class="d-none d-lg-block">{{ l('املاک کلبه') }}</span>
            <span class="d-lg-none">{{ l('کلبه') }}</span>
