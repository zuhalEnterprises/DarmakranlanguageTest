        ...
        <div class="row mt-4 pt-3 TextContentArticle">
            <div class="{{$recentposts != null && $model->type != 'page' ? 'col-lg-8' : 'col-lg-12'}}">
                ...
                <div class="d-flex flex-wrap border-bottom pb-3 mb-4">
                    ...
                    <div class="d-flex align-items-center border-end px-3 me-3 mb-2">
                        <i class="fi-pencil opacity-70 me-2"></i>
                        <a target="_blank" href="/profile/posts/edit/{{$model->id}}">{{l(' ویرایش بلاگ')}}</a>
                    </div>
                ...
                @endif
                @if((isset($avgApartment) && $avgApartment>0) || (isset($avgApartment5) && $avgApartment5>0) || (isset($avgApartment10) && $avgApartment10>0))
                @if($avgApartment>0)
                        ...
                        <div class="card card-flush pb-3 pb-lg-0 mb-4">
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-start border-bottom border-light pb-3 mb-3">
                                    ...
                                    @endif
                                    <div class="px-3">
                                        <a class="fs-base text-uppercase text-primary text-decoration-none" href="{{$item->url()}}">{{$item->title}}</a>
                                        <p class="fs-xs pt-1 mb-2">
                                            <a class="nav-link" href="#">{{($item->category) ? $item->category->name : ''}}</a>
                                        </p>
