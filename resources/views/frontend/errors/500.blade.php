@extends(ss('THEME').'.frontend.layouts.intro.appnew_v2',['title'=>$message])
        ...
        <div class="row align-items-md-center gy-4">
          <div class="col-lg-4 order-lg-1 order-2 position-relative py-lg-0 py-5 text-lg-end text-center">
            ...
            <div class="position-relative zindex-5">
              <h1 class="display-6  text-light">{{ l('متاسفانه مشکلی پیش آمده است') }}</h1>
              <p class="mb-lg-4 mb-3 pb-lg-3 fs-lg text-light opacity-70">{{ l('نگران نباش! مشکل در حال بررسی توسط تیم فنی ماست :)') }}</p>
