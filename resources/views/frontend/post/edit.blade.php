...
@section('main_content')
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                @endif
                <form role="form" method="POST" action="{{url('/admin/posts/'.$model->id)}}"
                    ...
                    <div class="box-body" style="padding: 15px !important">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-lg-3 ">
                                <span class="label-tooltip" data-toggle="tooltip" data-html="true" title="">{{ l('خلاصه مطلب') }}</span>
                            </label>

                            <div class="col-lg-9">
                                <textarea type="text" class="form-control" name="description" id="description" style="min-height: 100px"  >{{$model->description}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                            <textarea style="height:500px" class="form-control" name="body" id="editor1"
                                                      autofocus  rows="30"><?php echo $model->body; ?></textarea>
                        ...
                        $all = $productTags->map( function ( $item ) {
                            $new         = array();
                            $new['id']   = $item->id;
                            $new['name'] = $item->name;
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" name="meta_title" id="meta_title" value="{{$model->meta_title}}"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <textarea class="form-control" name="meta_description" id="meta_description">{{$model->meta_description}}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-9">
                                <input class="form-control" name="link_rewrite" id="link_rewrite" value="{{$model->link_rewrite}}"/>
                            </div>
                        </div>
                        -->
                    </div>
...
@section('js')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            /*var selected_categories = <?php (json_encode( $model->categories ) == null)?'':json_encode( $model->categories ); ?>;
            for(var i=0; i< selected_categories.length; i++){
                $("input#cat_id[value='"+selected_categories[i]+"']").prop('checked', true);
            }*/
