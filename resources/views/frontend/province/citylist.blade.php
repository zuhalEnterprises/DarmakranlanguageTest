<table class="table table-bordered table-striped table-hover">
    <thead class="table-primary">
        <tr>
            ...
            @if(env('COUNTRY') != 'UAE')
            <th valign="middle" class="header" style="text-align:center" scope="col">{{ l('استان') }}</th>
            <th valign="middle" class="header" style="text-align:center" scope="col">{{ l('تعداد مناطق') }}</th>
            @endif
    ...
    <tbody>
        ...
        <tr id="{{$item->id}}">
            ...
            <td valign="middle" align="center">
                @if($item->active == 1)
                    <i class="fi-check text-success me-2 status1" style="cursor: pointer"></i>
                @else
                    <i class="fi-x text-danger me-2 status1" style="cursor: pointer"></i>
                @endif
            </td>
            <td valign="middle" align="center">
                ...
                <ul class="dropdown-menu my-1" aria-labelledby="contextMenu2">
                    <li>
                        <a class="dropdown-item"  href="/profile/city/edit/{{$item->id}}">
