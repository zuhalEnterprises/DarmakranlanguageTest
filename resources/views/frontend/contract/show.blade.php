            ...
            @endif
                ...
                <div class="box clearfix">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ l('مشخصات قرارداد') }}</h3>
                    ...
                    <div class="box-body" style="padding: 15px !important">
                        ...
                        <div class="form-group row">
                            <label class="col-lg-3 control-label ">{{ l('کد قرارداد') }}</label>
                            <div class="col-md-5 text-aqua text-bold">{{$model->code}}</div>
                        </div>
                        <div class="form-group row">
                            <label class="col-lg-3 control-label ">{{ l('نوع قرارداد') }}</label>
                            <div class="col-md-5 text-maroon text-bold ">{{$model->typeName()}}</div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="control-label col-lg-3 ">{{ l('تاریخ ثبت قرارداد') }}</label>
                ...
                @if(count($model->contractUsers) > 0)
                    <div class="box clearfix">
                        <div class="box-header with-border">
                            <h3 class="box-title">{{ l('مشاوران فروشنده و خریدار:') }}<span class="box-title text-red">{{ l('درآمدهای قرارداد') }}</span></h3>
                        </div>
                        <div class="box-body" >
                            ...
                            <div class="col-lg-12">
                                <div class="bg-light border my-3 p-4 rounded">
                                    ...
                                    <span class="pull-right">
                                        ...
                                        <span>{{ l('کمیسیون مشاور فروش:') }}</span>
                                        ...
                                        <i class="fa-coins fal text-yellow"></i>
                                        <span>{{ l('کمیسیون مشاور خرید:') }}</span>
                                            ...
                                            <div class="bg-success form-group margin pad rounded row">
                                                <div class="col-lg-3" id="city_id">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control contract_users">{{$cu->{{ l('type == 1 ? \'مشاور فروشنده\' : \'مشاور خریدار\'}}') }}</div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                            ...
                                                            <div class="table-responsive no-padding" >
                                                                <table class="table table-advance table-hover" id="">
                                                                    ...
                                                                    @foreach($earnings as $item)
                                                                        ...
                                                                        {{-- نمایش کارشناس و مدیر شعبه دخیل در قرارداد --}}
        ...
        <form role="form" method="POST" id="frm-history" action="">
            ...
            <div class="modal-content" style="width: 650px;">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="exampleModalLabel">{{ l('تغییر وضعیت قرارداد :') }}
