        ...
        <div class="row">
            ...
            <nav class="mb-3 pt-md-3" aria-label="Breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="/profile/contract">{{l('قرارداد ها')}}</a></li>
                    <li class="breadcrumb-item active" aria-current="page"> {{l('نمایش پرداختی های قرارداد')}}</li>
                </ol>
            </nav>
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <h1 class="h2 mb-0">
                        {{l('نمایش پرداختی های قرارداد')}}
                    </h1>
                  <div>
...
<script>
    $('.trigger-swal').on('click', function () {
        swal("آیا از حذف قرارداد مطمئن هستید؟ ", {
  dangerMode: true,
  buttons: true,
});
