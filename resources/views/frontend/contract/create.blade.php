                            ...
                            <form role="form" id="add" method="POST" action="{{!empty($model)?"/profile/ContractEdit/".$model->id:"/profile/ContractAdd"}}"
                                ...
                                <section class="box" style="line-height: 250%">
                                    <div class="box-body" style="padding: 15px !important">
                                        <div class=" row ">
                                            <div class="col-12 ">
                                                <label class="form-label fw-bold  m-0">{{ l('نوع قرارداد') }}</label>
                                                <div class="">
                                                    <label class="radio-inline">
                                                        <input name="type" class="type" type="radio" {{ !empty($model) ? ($model->type == 1 ? 'checked' : '') : 'checked'}} value="1" > {{ l('فروش') }}
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input name="type" class="type" type="radio" {{ !empty($model) ? ($model->type == 2 ? 'checked' : '') : '' }} value="2"> {{ l('اجاره') }}
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input name="type" class="type" type="radio" {{ !empty($model) ? ($model->type == 3 ? 'checked' : '') : '' }} value="3"> {{ l('قرارداد ناموفق') }}
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input name="type" class="type" type="radio" {{ !empty($model) ? ($model->type == 4 ? 'checked' : '') : '' }} value="4"> {{ l('مشارکت در ساخت') }}
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input name="type" class="type" type="radio" {{ !empty($model) ? ($model->type == 5 ? 'checked' : '') : '' }} value="5"> {{ l('تهاتر') }}
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
                                            <div class="col-12 ">
                                                <label class="form-label fw-bold  m-0">{{ l('نوع ملک مورد معامله') }}</label>
                                                <div class="">
                                        ...
                                        <div class="row g-3 mt-3">
                                            <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                <label class="form-label fw-bold ">{{ l('کد قرارداد') }}</label>
                                                <input type="text" class="form-control" name="contractid" id="contractid"
                                                    value="{{ !empty($model) ? $model->contractid : '' }}" >
                                            </div>
                                            <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                <label class="form-label fw-bold ">{{ l('تاریخ قرارداد') }}</label>
                                                <input type="text" name="register_date" id="register_date"
                                                    value="{{ !empty($model) && $model->register_at>'1970-01-01' ? toPersianDateYdm($model->register_at) : '' }}"
                                                    onclick="Mh1PersianDatePicker.Show(this,'{{gregorian_to_jalali(date('Y'),date('m'),date('d'),'/')}}')"
                                                    class="form-control text-muted pull-right" >
                                            </div>
                                            <div class="col-md-4 col-sm-12 col-xs-12 totalprice">
                                                <label class="form-label fw-bold ">{{ l('تاریخ محضر') }}</label>
                                                <input type="text" name="registryofficedate" id="registryofficedate"
                                                    value="{{ !empty($model) && $model->registryofficedate>'1970-01-01' ? toPersianDateYdm($model->registryofficedate) : '' }}"
                                                    onclick="Mh1PersianDatePicker.Show(this,'{{gregorian_to_jalali(date('Y'),date('m'),date('d'),'/')}}')"
                                                    class="form-control text-muted pull-right" >
                                            </div>
                                            <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                <label class="form-label fw-bold ">{{ l('تاریخ تحویل') }}</label>
                                                <input type="text" name="deliverydate" id="deliverydate"
                                                    onclick="Mh1PersianDatePicker.Show(this,'{{gregorian_to_jalali(date('Y'),date('m'),date('d'),'/')}}')"
                                                    value="{{ !empty($model) && $model->deliverydate>'1970-01-01' ? toPersianDateYdm($model->deliverydate) : '' }}"
                                                    class="form-control text-muted pull-right" >
                                            </div>
                                            <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                <label class="form-label fw-bold ">{{ l('کد رهگیری') }}</label>
                                                <input type="text" class="form-control" name="tracking_code"
                                                    id="tracking_code"
                                                    value="{{ !empty($model) ? $model->tracking_code : '' }}" >
                                            </div>
                                        </div>
                                        <div class="row my-3">
                                            <div class="col-12 ">
                                        ...
                                        <div class="mt-2">
                                            <div class="box-header with-border">
                                                <h3 class="box-title text-aqua">{{ l('مشخصات') }}<label id="shop">{{ l('فروشنده') }}</label></h3>
                                            </div>
                                            <div class=" row g-3 mt-2">
                                                <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                    <label class="form-label fw-bold ">{{ l('کدملک') }}</label>
                                                    <input type="text" class="form-control number"
                                                        value="{{ !empty($model) ? $model->estate_id : '' }}"
                                                        name="estate_id" id="estate_id" >
                                                </div>
                                                <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                    <label class="form-label fw-bold ">{{ l('نام مالک') }}</label>
                                                    <input type="text" class="form-control "
                                                        value="{{ !empty($model) ? $model->estate_name : '' }}"
                                                        name="estate_name" id="estate_name" >
                                                </div>
                                                <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                    <label class="form-label fw-bold ">{{ l('کدملی مالک') }}</label>
                                                    <input type="text" class="form-control"
                                                        value="{{ !empty($model) ? $model->estate_nationalId : '' }}"
                                                        name="estate_nationalId" id="estate_nationalId" >
                                                </div>
                                                <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                    <label class="form-label fw-bold ">{{ l('شماره شناسنامه مالک') }}</label>
                                                    <input type="text" class="form-control number"
                                                        value="{{ !empty($model) ? $model->estate_idCard : '' }}"
                                                        name="estate_idCard" id="estate_idCard" >
                                                </div>
                                                <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                    <label class="form-label fw-bold ">{{ l('نام پدر مالک') }}</label>
                                                    <input type="text" class="form-control "
                                                        value="{{!empty($model) ? $model->estate_fatherName : '' }}"
                                                        name="estate_fatherName" id="estate_fatherName" >
                                                </div>
                                                <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                    <label class="form-label fw-bold ">{{ l('تلفن مالک') }}</label>
                                                    <input type="text" class="form-control number"
                                                        value="{{ !empty($model) ? $model->estate_phone : '' }}"
                                                        name="estate_phone" id="estate_phone"  maxlength="11" minlength="11">
                                                </div>
                                            </div>
                                            <div class="row my-3">
                                                <div class="col-12 ">
                                                    <label class="form-label fw-bold ">{{ l('آدرس') }}</label>
                                                    <textarea class="form-control" name="estate_address"
                                                        id="estate_address" >{{ !empty($model) ? $model->estate_address : '' }}</textarea>
                                                </div>
                                            </div>
                                            <div class="row my-3">
                                                <div class="col-md-6 col-sm-12 col-xs-12 totalprice">
                                                    <label class="form-label fw-bold ">{{ l('قیمت کل (تومان)') }}</label>
                                                    <input  class="form-control  js_Splitnumber1" type="text" onkeypress="OnlyNumber(event,false)" onkeyup="SplitNumber($(this));" name="total_price"
                                                        id="total_price" value="{{ !empty($model) ? toPersianNumbers($model->total_price) : '0' }}" >
                                                </div>
                                                <div class="col-md-6 col-sm-12 col-xs-12 totalrent d-none" >
                                                    <label class="form-label fw-bold ">{{ l('رهن (تومان)') }}</label>
                                                    <input  class="form-control  js_Splitnumber1" type="text"   onkeypress="OnlyNumber(event,false)" onkeyup="SplitNumber($(this));" name="total_mortgage"
                                                        id="total_mortgage" value="{{ !empty($model) ? toPersianNumbers($model->total_mortgage) : '0' }}" >
                                                </div>
                                                <div class="col-md-6 col-sm-12 col-xs-12 totalrent d-none">
                                                    <label class="form-label fw-bold ">{{ l('اجاره (تومان)') }}</label>
                                                    <input  class="form-control  js_Splitnumber1" type="text"   onkeypress="OnlyNumber(event,false)" onkeyup="SplitNumber($(this));" name="total_rent"
                                                        id="total_rent" value="{{ !empty($model) ? toPersianNumbers($model->total_rent) : '0' }}" >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="my-2">
                                            <div class="box-header with-border">
                                                <h3 class="box-title text-aqua">{{ l('مشخصات') }}<label id="buy">{{ l('خریدار') }}</label></h3>
                                            </div>
                                            <div class=" row my-3 g-3">
                                                <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                    <label class="form-label fw-bold ">{{ l('کد مشتری') }}</label>
                                                    <input type="text" class="form-control number"
                                                        value="{{ !empty($model) ? $model->customer_id : '' }}"
                                                        name="customer_id" id="customer_id" >
                                                </div>
                                                <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                    <label class="form-label fw-bold ">{{ l('نام مشتری') }}</label>
                                                    <input type="text" class="form-control "
                                                        name="customer_name"
                                                ...
                                                <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                    <label class="form-label fw-bold ">{{ l('کدملی مشتری') }}</label>
                                                    <input type="text" class="form-control "
                                                        value="{{ !empty($model) ? $model->customer_nationalId : '' }}"
                                                        name="customer_nationalId" id="customer_nationalId">
                                                </div>
                                                <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                    <label class="form-label fw-bold ">{{ l('شماره شناسنامه مشتری') }}</label>
                                                    <input type="text" class="form-control number"
                                                        value="{{ !empty($model) ? $model->customer_idCard : '' }}"
                                                        name="customer_idCard" id="customer_idCard" >
                                                </div>
                                                <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                    <label class="form-label fw-bold ">{{ l('نام پدر مشتری') }}</label>
                                                    <input type="text" class="form-control "
                                                        value="{{!empty($model) ? $model->customer_fatherName : '' }}"
                                                        name="customer_fatherName" id="customer_fatherName" >
                                                </div>
                                                <div class="col-md-4 col-sm-12 col-xs-12 ">
                                                    <label class="form-label fw-bold ">{{ l('تلفن مشتری') }}</label>
                                                    <input type="text" class="form-control number"
                                                        name="customer_phone"
                                                        value="{{ !empty($model) ? $model->customer_phone : '' }}"
                                                        id="customer_phone"  maxlength="11" minlength="11">
                                                </div>
                                            </div>
                                        </div>
                                        {{-- users --}}
                                                            ...
                                                            <div class="box-footer  margin pad rounded row shadow-sm"
                                                                ...
                                                                <div class="col-lg-3 col-sm-12">
                                                                    ...
                                                                    <select name="contract_users[]" id=""
                                                                        class="form-control contract_users" >
                                                                ...
                                                                <div class="col-lg-4 col-sm-12">
                                                                    ...
                                                                    <select name="contract_users1[]" id="expert_id"
                                                                        class="form-control contract_users agent" >
                                                                ...
                                                                <div class="col-lg-3 col-sm-12">
                                                                    ...
                                                                    <input name="contract_users2[]" type="text"
                                                                        class="form-control digits contract_users2"
                                                                        value="" >
                                                                </div>
                                                            ...
                                                            <div class="box-footer  margin pad rounded row shadow-sm"
                                                                ...
                                                                <div class="col-lg-3 col-sm-12">
                                                                    ...
                                                                    <select name="contract_users_old[]" id=""
                                                                        class="form-control contract_users" >
                                                                        <option value="1" {{$contractUsers->type==1?'selected':''}} selected>{{ l('مشاور فروشنده') }}
                                                                        </option>
                                                                        <option value="2" {{$contractUsers->type==2?'selected':''}} >{{ l('مشاور خریدار') }}</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-lg-4 col-sm-12">
                                                                    <label class="control-label ">{{ l('کد مشاور') }}</label>
                                                                ...
                                                                <div class="col-lg-3 col-sm-12">
                                                                    ...
                                                                    <input name="contract_users2_old[]" type="text"
                                                                        class="form-control digits contract_users2"
                                                                        value="{{$contractUsers->expert_commission}}" >
                                                                </div>
                                                                <div class="col-lg-2 col-sm-12">
...
$(".remove-img").on("click", function () {
    ...
    swal({
                ...
                if (key == 13) {
                    ...
                    if ($(this).val() != 0) {
                        $.get('/estateget/' + $(this).val(), function (data, status) {
                            ...
                            $(".buy").find('.agent').val(data.html['expert_id']);
                            $("#d"+data.html['expert_id']).find(".contract_users").val(1);
                            $("#estate_name").val(data.html['owner_name']);
                            $("#estate_phone").val(data.html['phone']);
                            var stre="";
                            if(data.html['street']!=null){
                                stre=data.html['street']['name'];
                            }
        ...
        function savecheck(){
                var isValid = true;
                $('input,textarea,select').filter('[]:visible').each(function() {
                if ( $(this).val() === '' )
                    isValid = false;
                });
                if(isValid==true)
...
var type1= $("input[name='type']:checked").val();
                if(type1==2){
                    $("#shop").text(l("موجر"));
                    $("#buy").text(l("مستاجر"));
                    $(".totalprice").addClass('d-none').removeClass('d-block');
                    $(".totalrent").addClass('d-block').removeClass('d-none');

                }
                else{
                    $("#shop").text(l("فروشنده"));
                    $("#buy").text(l("خریدار"));
                    $(".totalprice").addClass('d-block').removeClass('d-none');
                    $(".totalrent").addClass('d-none').removeClass('d-block');
                }
