...
{{--    <meta name="keyword" content="{{config('app.title_fa')}}|@yield('metaKeyword')">--}}
    ...
    <!-- RTL -->
    @if(in_array($currentLocale ?? 'fa', ['fa', 'ar']))
    ...
    <!-- pushmenu -->
    <link rel="stylesheet" href="{{asset('/frontend/css/pushmenu.css')}}">
    ...
    <style>
        ...
        .container:not(.container.experts,.expert-form .container){ min-height: 490px}
        .divar-tabs .nav-link{
...
<body class="@yield('body_class')">
    ...
    <!-- pushmenu -->
    <script type="text/javascript" src="{{asset('/frontend/js/pushmenu.js')}}"></script>
