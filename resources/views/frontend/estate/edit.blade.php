                                            ...
                                            <div id="images" class=" card mb-3">
                                                ...
                                                <div class="card-body align-content-center align-items-center d-flex flex-row flex-wrap justify-content-around">
                                                    ...
                                                    @foreach($estate->images as $item)
                                                        <div id="media-{{$item->id}}" data-id="{{$item->id}}" class="card p-1 rounded dz-preview {{$defaultImage && $defaultImage->id == $item->id ? 'img-cover' : ''}}" style="margin-bottom:10px">
                                                            <p class="mb-0">
                                                                <a target="_blank">
                                                                    <img src="{{ asset("/upload/images/estate/".$item->dimension['small'])}}" class="w-100" style="height:250px;margin-bottom:10px">
                                                                </a>
                                                            </p>
