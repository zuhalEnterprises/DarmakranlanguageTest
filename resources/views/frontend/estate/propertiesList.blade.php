                ...
                <div class="card shadow-sm rounded mb-4">
                    <div class=" card-body border-0  pb-1 me-lg-1">
                        ...
                        <div class="row">
                            ...
                            @if($type != 1 && ($currentUser->isAdmin() || $currentUser->isExpert()))
                            <div class="col-6 col-md-6 col-lg-3 col-sm-6 mt-3">
                        ...
                        @endif
                            ...
                            <div class="col-6 col-md-6 col-lg-3 col-sm-6 mt-3  not"  access="13,14,23,24">
                                ...
                                <select class="form-select" name="position_type"  id="position_type">
                                    ...
                                    <option value="269" >{{ l('دور میدان') }}</option>
                                    <option value="270">{{ l('داخل بازار') }}</option>
                                    <option value="272">{{ l('داخل شهرک صنعتی') }}</option>
                                    ...
                                    <option value="345" >{{ l('داخل طرح هادی') }}</option>
                                    <option value="273" >{{ l('سایر') }}</option>
                                </select>
                            </div>
                            @endif
                            <div class="col-6 col-md-6 col-lg-3 col-sm-6 mt-3">
                            ...
                            <div class="col-6 col-md-6 col-lg-3 col-sm-6 mt-3 not" access="11,12,13,14,15" id="sale-inputs">
                                ...
                                <select class="form-label"  name="exchange" id="exchange">
                                    <option value="" >{{l('انتخاب کنید')}}</option>
                                    ...
                                    <div class="accordion-body">
                                        <div class="row">
                                            ...
                                            <div class="col-6 col-md-6 col-lg-3 col-sm-6 mt-3 not" access="12,22">
                                                ...
                                                <select   style="width: 100%" class="form-control select2" id="floor_start" name="floor_start">
                                                    <option value="" selected>{{ l('انتخاب نمایید') }}</option>
                                                    <option value="257">{{ l('زیرزمین') }}</option>
                                                    <option value="258">{{ l('همکف') }}</option>
                                                    <option value="259">{{ l('پیلوت') }}</option>
                                                </select>
                                            </div>
                                            <!--
                                        ...
                                        <div class="row">
                                            ...
                                            @endif
                                            <div class="col-6 col-md-6 col-lg-3 col-sm-6 mt-3 not"  access="11">
                                                <input class="form-check-input" type="checkbox" id="onebuilding" name="onebuilding" value="1">
                                            ...
                                            <div class="col-6 col-md-6 col-lg-3 col-sm-6 mt-3  not" access="11,12,13,15,21,22,23,25">
                                                <input class="form-check-input condition" type="checkbox" id="condition251"  name="condition[]" value="251">
                                            ...
                                            <div class="col-6 col-md-6 col-lg-3 col-sm-6 mt-3 not" access="12,14">
                                                <input class="form-check-input condition" type="checkbox" id="condition250" name="condition[]" value="250">
                                            ...
                                            <div class="col-6 col-md-6 col-lg-3 col-sm-6 mt-3 not" access="13,23">
                                                <input class="form-check-input balconmetraj2" type="checkbox" id="balconmetraj2" nama="balconmetraj2"  value="1">
                                                <label class="form-check-label fs-sm" for="balconmetraj2">{{ l('دارای بالکن') }}</label>
                                            </div>
                                            <div class="col-6 col-md-6 col-lg-3 col-sm-6 mt-3 not" access="13,23">
                                                <input class="form-check-input undermetraj2" type="checkbox" id="undermetraj2" nama="undermetraj2" value="1">
...
<script>
    ...
    function loadMoreData(page,type)
    {
        ...
        $.ajax({
                url: "/propertiesShow?page="+page+"&&usertype={{$type}}&&"+type,
                type: "get",
                beforeSend: function() {
...
<script>
    ...
    function SetMapCluster(sr) {
        $.ajax({
                url: `/profile/propertiesShow?mapexists=1&&usertype={{$type}}&&${sr}`,
                type: "get",
                beforeSend: function() {
