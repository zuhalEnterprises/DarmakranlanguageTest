...
<div class="col-sm-6 col-md-6 col-lg-4 mb-4 main">
    ...
    <div class="property_listing_wrapper h-100">
        <div class="property_listing ovh pos-r h-100 font_9 d-flex flex_direction_column mx-auto">
            ...
            <div class="property-unit-information-wrapper flex-grow-1">
                <!-- عنوان -->
                <h5 class="title">
                    <a class="font_15 font_800 color_black" href="{{ $estate->url() }}">{{$estate->type==1? l("فروش"):l("رهن و اجاره")}} {{estateTypes($estate->estate_type)}} {{!empty($estate->area)?$estate->area." متری":l("توافقی") }}
