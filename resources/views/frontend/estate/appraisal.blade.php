...
@section('main_content')
    ...
    <main class="page-wrapper">
        ...
        <div class="container mt-5 mb-md-4 pt-5">
            <nav class="mb-3 pt-md-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ l('ارزیابی قیمت ملک') }}</li>
                </ol>
            </nav>
        </div>
        <!-- Hero-->
        <section class="container mb-5 pb-2 pb-lg-4">
            <div class="mb-4">
                    <h1 class="h2 mb-0">{{ l('ارزیابی قیمت ملک') }}</h1>
            </div>
            <p class="fw-bold">
                {{ l('چنانچه قصد دارید از قیمت دقیق ملک خود مطلع شوید، فرم زیر را پر کنید تا همکاران ما با شما تماس بگیرند.') }}
            </p>
