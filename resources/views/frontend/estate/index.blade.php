...
@section('main_content')
    ...
    <main class="page-wrapper">
        ...
        <!-- Page container-->
        <div class="container mt-6 pt-5 p-0" style="">
                        ...
                        <div class="offcanvas-body py-lg-4">
                                ...
                                <div class="d-flex justify-content-between align-items-start gap-1">
                                    <div style="border:1px solid #d5d2dc" class="rounded-1 text-center px-18px ">
                                        <button selected style="border:0px;background:white" class="flex items-center justify-between w-full h-59px js_min_button js_min_Price js_button">
                                            ...
                                            <input type="hidden" id="minPrice" name="minPrice" value="{{app('request')->input('minprice')}}">
                                            <input type="text" id="minPrice1" placeholder="{{l('حداقل')}} " value="{{app('request')->input('minprice')}}" name="minPrice1" style="border:0px;background:white" class="text-gray-400 font-light w-full outline-0 text-center js_min_max_input js_price input-price">
                                        </button>
                                        <ul class="hidden text-right text-gray-500 font-light space-y-3 overflow-auto scroll-p-4 duration-300 h-0 h-260px css_scroll js_min_query_2 miniprice">
                                            ...
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500 js_items js_min js_filter_action1" value="50000000" onclick="js_price('min',50000000)">{{ l('50 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500 js_items js_min js_filter_action1" value="100000000" onclick="js_price('min',100000000)">{{ l('100 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500 js_items js_min js_filter_action1" value="200000000" onclick="js_price('min',200000000)">{{ l('200 میلیون') }}</button>
                                            </li>
                                            <li>
                                ...
                                <div class="d-flex justify-content-between align-items-start gap-1">
                                    ...
                                    <div style="border:1px solid #d5d2dc" class="rounded-1 text-center px-18px ">
                                        <button selected style="border:0px;background:white" class="flex items-center justify-between w-full h-59px js_max_button js_max_Price js_button">
                                            ...
                                            <input type="text" name="maxPrice1" id="maxPrice1" value="{{app('request')->input('maxprice')}}" placeholder="{{l('حداکثر')}} " style="border:0px;background:white" class="text-gray-400 font-light w-full outline-0 text-center js_min_max_input js_price input-price">
                                            <input type="hidden" name="maxPrice" id="maxPrice" value="{{app('request')->input('maxprice')}}">
                                        </button>
                                ...
                                <div class="d-flex justify-content-between align-items-start gap-1">
                                    <div style="border:1px solid #d5d2dc" class="rounded-1 text-center px-18px ">
                                        ...
                                        <ul class="hidden text-right text-gray-500 font-light space-y-3 overflow-auto scroll-p-4 duration-300 h-0 h-260px css_scroll js_min_query_2 miniprice">
                                            ...
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500 js_items js_min js_filter_actionRahn" value="50000000" onclick="js_price('min',50000000)">{{ l('50 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500 js_items js_min js_filter_actionRahn" value="100000000" onclick="js_price('min',100000000)">{{ l('100 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500 js_items js_min js_filter_actionRahn" value="200000000" onclick="js_price('min',200000000)">{{ l('200 میلیون') }}</button>
                                            </li>
                                            <li>
                                    ...
                                    <div style="border:1px solid #d5d2dc" class="rounded-1 text-center px-18px ">
                                        ...
                                        <ul class="maxirahn hidden text-right text-gray-500 font-light space-y-3 overflow-auto scroll-p-4 duration-300 h-0 h-260px css_scroll  js_max_query_2">
                                            ...
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500  js_items js_max js_filter_actionRahn" value="50000000" onclick="js_price('max',50000000)">{{ l('50 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500  js_items js_max js_filter_actionRahn" value="100000000" onclick="js_price('max',100000000)">{{ l('100 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500  js_items js_max js_filter_actionRahn" value="200000000" onclick="js_price('max',200000000)">{{ l('200 میلیون') }}</button>
                                            </li>
                                            <li>
                                ...
                                <div class="d-flex justify-content-between align-items-start gap-1">
                                    <div style="border:1px solid #d5d2dc" class="rounded-1 text-center px-18px ">
                                        ...
                                        <ul class="hidden text-right text-gray-500 font-light space-y-3 overflow-auto scroll-p-4 duration-300 h-0 h-260px css_scroll js_min_query_2 miniprice">
                                            ...
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500 js_items js_min js_filter_actionRent" value="1000000" onclick="js_price('min',1000000)">{{ l('یک میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500 js_items js_min js_filter_actionRent" value="5000000" onclick="js_price('min',5000000)">{{ l('5 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500 js_items js_min js_filter_actionRent" value="10000000" onclick="js_price('min',10000000)">{{ l('10 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500 js_items js_min js_filter_actionRent" value="20000000" onclick="js_price('min',20000000)">{{ l('20 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500 js_items js_min js_filter_actionRent" value="50000000" onclick="js_price('min',50000000)">{{ l('50 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500 js_items js_min js_filter_actionRent" value="100000000" onclick="js_price('min',100000000)">{{ l('100 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500 js_items js_min js_filter_actionRent" value="200000000" onclick="js_price('min',200000000)">{{ l('200 میلیون') }}</button>
                                            </li>
                                            <li>
                                    ...
                                    <div style="border:1px solid #d5d2dc" class="rounded-1 text-center px-18px ">
                                        ...
                                        <ul class="maxirahn hidden text-right text-gray-500 font-light space-y-3 overflow-auto scroll-p-4 duration-300 h-0 h-260px css_scroll  js_max_query_2">
                                            ...
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500  js_items js_max js_filter_actionRent" value="1000000" onclick="js_price('max',1000000)">{{ l('یک میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500  js_items js_max js_filter_actionRent" value="5000000" onclick="js_price('max',5000000)">{{ l('5 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500  js_items js_max js_filter_actionRent" value="10000000" onclick="js_price('max',10000000)">{{ l('10 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500  js_items js_max js_filter_actionRent" value="20000000" onclick="js_price('max',20000000)">{{ l('20 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500  js_items js_max js_filter_actionRent" value="50000000" onclick="js_price('max',50000000)">{{ l('50 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500  js_items js_max js_filter_actionRent" value="100000000" onclick="js_price('max',100000000)">{{ l('100 میلیون') }}</button>
                                            </li>
                                            <li>
                                                <button style="background: white;border:0px" class="cursor-pointer w-full text-right text-gray-500  js_items js_max js_filter_actionRent" value="1100000000" onclick="js_price('max',200000000)">{{ l('200 میلیون') }}</button>
                                            </li>
                            ...
                            <div class="pb-4 mb-2">
                                ...
                                <div class=""
                                    data-simplebar-direction="rtl" >
                                    <div class="form-check">
                                        <input class="form-check-input condition" type="checkbox" id="condition1" name="condition1" value="15"
                                            onchange="checkSend()">
                                        <label class="form-check-label fs-sm" for="condition1">{{l('پیش فروش')}}</label>
                                    </div>
                                    @if(env('COUNTRY') != 'UAE')
                                    <div class="form-check">
                                        <input class="form-check-input condition" type="checkbox" id="condition2" name="condition2" value="17"
                                            onchange="checkSend()">
                                        <label class="form-check-label fs-sm" for="condition2">{{l('وام دار')}}</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input condition" type="checkbox" id="condition3" name="condition3" value="250"
                                            onchange="checkSend()">
                                        <label class="form-check-label fs-sm" for="condition3">{{l('مشارکت در ساخت')}}</label>
                                    </div>
                                    <div class="form-check">
                                        <input class="form-check-input condition" type="checkbox" id="condition4" name="condition4" value="251"
                                            onchange="checkSend()">
                                        <label class="form-check-label fs-sm" for="condition4">{{ l('کلنگی') }}</label>
                                    </div>
                                    @endif
                                    <div class="form-check">
                                        <input class="form-check-input condition" type="checkbox" id="condition7" name="condition7" value="344"
                                            onchange="checkSend()">
                                        <label class="form-check-label fs-sm" for="condition6">{{l('بازسازی شده')}}</label>
                                    </div>
                                </div>
                            </div>
--}}
...
@section('js')
    ...
    <script type="text/javascript">
        ...
        //golab
        /*function loadMoreData_v1(page, type2) {
            flagcheck=true;
            $("#backlazy").show();
            if (page == 1) {
