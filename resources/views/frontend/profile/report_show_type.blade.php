        ...
        <div class="card expert-list">
            <div class="card-body py-2">
                ...
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    ...
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="/customer?user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}"> {{l('ثبت مشتری')}}</a>
                    <p class="m-0 fw-bold">
                        <a href="/customer?user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}" target="_blank">
                ...
                @if(env('COUNTRY') != 'UAE')
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="/profile/editsEstate?type=showdate&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}">   {{l('نردبان')}}</a>
                    <p class="m-0 fw-bold">
                        <a href="/profile/editsEstate?type=showdate&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}" target="_blank">
                ...
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="/profile/contract?type=1&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}">{{ l('تعداد قرارداد خرید و فروش') }}</a>
                    <p class="m-0 fw-bold">
                        <a href="/profile/contract?type=1&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}" target="_blank">
                ...
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="/profile/contract?type=2&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}">{{ l('تعداد قرارداد رهن و اجاره') }}</a>
                    <p class="m-0 fw-bold">
                        <a href="/profile/contract?type=2&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}" target="_blank">
                ...
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="/profile/contract?type=1&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}">{{ l('تعداد قرارداد اشتراکی خرید و فروش') }}</a>
                        <p class="m-0 fw-bold">
                            <a href="/profile/contract?type=1&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}" target="_blank">
                ...
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="/profile/contract?type=2&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}">{{ l('تعداد قرارداد اشتراکی رهن و اجاره') }}</a>
                    <p class="m-0 fw-bold">
                        <a href="/profile/contract?type=2&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}" target="_blank">
                ...
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="/profile/contract?type=3&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}">{{ l('تعداد قرارداد ناموفق') }}</a>
                    <p class="m-0 fw-bold">
                        <a href="/profile/contract?type=3&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}" target="_blank">
                ...
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="/profile/contract?type=4&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}">{{ l('تعداد قرارداد تهاتر') }}</a>
                    <p class="m-0 fw-bold">
                        <a href="/profile/contract?type=4&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}" target="_blank">
                ...
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="/profile/contract?type=4&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}">{{ l('تعداد قرارداد تهاتر مشارکتی') }}</a>
                    <p class="m-0 fw-bold">
                        <a href="/profile/contract?type=4&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}" target="_blank">
                            {{$reportCommonTahatorContractCount}}
                            @if(ss('SITE_ID') == 3)
                            (ضریب {{(int)getsetting('statictis','commontahatorcontract')}})
                            @endif
                        </a>
                    </p>
                </div>
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="/profile/contract?type=5&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}">{{ l('تعداد قرارداد مشارکت') }}</a>
                    <p class="m-0 fw-bold">
                        <a href="/profile/contract?type=5&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}" target="_blank">
                ...
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="/profile/contract?type=5&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}">{{ l('تعداد قرارداد مشارکت مشارکتی') }}</a>
                    <p class="m-0 fw-bold">
                        <a href="/profile/contract?type=5&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}" target="_blank">
                            {{$reportCommonMosharekatContractCount}}
                            @if(ss('SITE_ID') == 3)
                            (ضریب {{(int)getsetting('statictis','commonmosharekatcontract')}})
                            @endif
                        </a>
                    </p>
                </div>
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="/profile/contractearn/0?type=buy&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}">{{ l('درآمد خرید و فروش') }}</a>
                    <p class="m-0 fw-bold">
                        <a href="/profile/contractearn/0?type=buy&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}" target="_blank">
                ...
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="/profile/contractearn/0?type=rent&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}">{{ l('درآمد رهن و اجاره') }}</a>
                    <p class="m-0 fw-bold">
                        <a href="/profile/contractearn/0?type=rent&user_id={{$request->user_id}}&datefrom={{$request->datefrom}}&dateto={{$request->dateto}}" target="_blank">
                ...
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="">{{ l('مشاهده املاک ارسال شده') }}</a>
                    <p class="m-0 fw-bold">
                        <a href="" target="_blank">
                        {{$reportViewRelationCount}}
                        </a>
                    </p>
                </div>
                <div class="d-flex align-items-center justify-content-between mb-2 border-bottom pb-2">
                    <a class=" text-decoration-none text-dark line-height-normal mb-1 fw-bold py-1" href="">{{ l('پیامک املاک متناسب') }}</a>
                    <p class="m-0 fw-bold">
                        <a href="" target="_blank">
                        {{$reportSentRelationCount}}
                        </a>
                    </p>
                </div>
                @endif
