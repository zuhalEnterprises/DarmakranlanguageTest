                ...
                <div class="card border-0 bg-secondary p-sm-3 p-2">
                  <div class="card-body m-1">
                    <p style="margin-left:0px; margin-right:0px; text-align:start">
                        {{ l('شعبه جمهوری: قم، بلوار جمهوری، نبش خیابان قیام') }}
<br><br>
{{ l('شعبه پردیسان: قم، پردیسان، بلوار سلمان، روبروی مسجد حضرت فاطمه‌الزهرا، هویزه2') }}


<br><br>
{{ l('شماره تماس : 3180-025') }}




<br><br>
آدرس صفحات ما : koomeh.amlak@
          ...
          <section class="container mb-5 pb-2 pb-md-4 pb-lg-5">
            <div class="row g-4">
              <!-- Item-->
              <div class="col-md-4"><a class="icon-box card card-hover h-100" href="mailto:info@koomeh.ir">
                  <div class="card-body">
                    ...
                    <h3 class="h5 icon-box-title mb-0 opacity-90">info@koomeh.ir</h3>
                  </div></a></div>
              <!-- Item-->
              <div class="col-md-4"><a class="icon-box card card-hover h-100" href="tel:0253180">
                  <div class="card-body">
                    ...
                    <h3 class="h5 icon-box-title mb-0 opacity-90 ltr">025-3180</h3>
                  </div></a></div>
              <!-- Item-->
              <div class="col-md-4"><a class="icon-box card card-hover h-100" href="#">
                  <div class="card-body">
                    ...
                    <h3 class="h5 icon-box-title mb-0 opacity-90 ltr">@koomeh.amlak</h3>
                  </div></a></div>
            </div>
          </section>
    </main>
