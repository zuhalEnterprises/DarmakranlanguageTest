...
@section('js')
    ...
    <script type="text/javascript">
        ...
        function filter()
        {
            ...
            $('input[name="store"]:checked').length>0 ?facilities.push("36") : "";
            $('input[name="elevator"]:checked').length>0 ?facilities.push("37"): "";
            $('input[name="parking"]:checked').length>0 ?facilities.push("35"): "";
            //alert(facilities);
