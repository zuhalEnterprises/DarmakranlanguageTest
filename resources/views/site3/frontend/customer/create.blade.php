...
<div class="col-sm-3 mb-3 buyer-content">
    <div>
        ...
        <select class="form-control" name="label" id="label">
            <option value="4" {{!empty($model)?($model->label== 4 ? 'selected' : ''):''}}></option>
...
<div class="col-sm-4 mb-3 buyer-content">
    <div>
        <label class="form-label fw-bold" for="conditions372">
            {{ l('ویژه طلاب') }}
        </label>
        <input class="form-check-input" id="conditions372" {{!empty($model)?checkValueCreate($model->conditions,372):""}} value="372" type="checkbox" name="conditions[]">
    </div>
</div>
...
<div class="col-sm-6 mb-3 buyer-content">
    <div>
        <label class="input-title" for="existing_document">{{l('سند موجود')}} </label>
...
<div class="col-sm-6 mb-3 buyer-content">
    <div>
        <label class="input-title" for="unit_in_complex">{{l('واحد در مجتمع مسکونی')}} </label>
        <input class="form-check-input" name="unit_in_complex" value="1" type="checkbox" id="unit_in_complex" {{!empty($model)?(($model->unit_in_complex == 1)?"checked":""):""}}>
