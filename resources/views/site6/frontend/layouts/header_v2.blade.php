...
<header class="navbar navbar-expand-lg navbar-light bg-light fixed-top shadow-lg" data-scroll-header>
    <div class="container gap-1" style="margin-top: 0 !important;">
        ...
        ?>
        <a class="btn btn-primary btn-sm ms-2 order-lg-3 d-none d-lg-block" href="/customers/create"><i class="fi-plus me-2"></i>{{ l('ثبت مشتری') }}</a>
            ...
            <ul class="navbar-nav navbar-nav-scroll m-0" style="max-height: 35rem;">
                ...
                <li class="nav-item d-lg-none">
                    <a class="nav-link" href="/customers/create">
                        <i class="fi-plus me-2"></i>   {{ l('ثبت مشتری') }}
                    </a>
                </li>
