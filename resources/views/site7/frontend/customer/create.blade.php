                    ...
                    <section class="card card-body p-4 mb-4" id="basic-info">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <select class="form-select"  name="request_type" id="deal_type" required >
                                        <option value="" disabled hidden>{{l('دسته بندی')}}</option>
                                        <option value="1" {{!empty($model)?($model->request_type==1?'selected':''):""}}>{{l('فروش')}}</option>
                                        <option value="2" {{!empty($model)?($model->request_type==2?'selected':''):""}}>{{l('اجاره')}}</option>
                                        <option value="3" {{!empty($model)?($model->request_type==3?'selected':''):""}}>{{l('اجاره کوتاه مدت')}}</option>
                                    </select>
                                ...
                                <div class="col-sm-6 mb-3">
                                    ...
                                    <select class="form-select" id="estate_type" name="estate_type" required>
                                        ...
                                        <optgroup label=l("فروش مسکونی") id="sale1">
                                            <option value="1"  @php echo (!empty($model) && $model->estate_type == 1 ? "selected" :'') @endphp>{{ l('آپارتمان') }}</option>
                                            <option value="2"  @php echo (!empty($model) && $model->estate_type == 2 ? "selected" :'') @endphp>{{ l('منزل ویلایی') }}</option>
                                            <option value="3"  @php echo (!empty($model) && $model->estate_type == 3 ? "selected" :'') @endphp>{{ l('زمین و خانه کلنگی') }}</option>
                                            <option value="6"  @php echo (!empty($model) && $model->estate_type == 6 ? "selected" :'') @endphp>{{ l('آپارتمان یک جا') }}</option>
                                            <option value="7"  @php echo (!empty($model) && $model->estate_type == 7 ? "selected" :'') @endphp>{{ l('باغ و ویلا') }}</option>
                                        </optgroup>
                                        <optgroup label=l("فروش اداری و تجاری") id="sale2">
                                            <option value="5"  @php echo (!empty($model) && $model->estate_type == 5 ? "selected" :'') @endphp>{{ l('صنعتی') }}</option>
                                            <option value="8"  @php echo (!empty($model) && $model->estate_type == 8 ? "selected" :'') @endphp>{{ l('زمین کشاورزی و باغ') }}</option>
                                            <option value="9"  @php echo (!empty($model) && $model->estate_type == 9 ? "selected" :'') @endphp>{{ l('مغازه و غرفه') }}</option>
                                            <option value="10" @php echo (!empty($model) && $model->estate_type == 10 ? "selected" :'') @endphp>{{ l('کارگاه و کارخانه') }}</option>
                                            <option value="11" @php echo (!empty($model) && $model->estate_type == 11 ? "selected" :'') @endphp>{{ l('آپارتمان تجاری یک جا') }}</option>
                                            <option value="12" @php echo (!empty($model) && $model->estate_type == 12 ? "selected" :'') @endphp>{{ l('اداری, دفتر کار و مطب') }}</option>
                                            <option value="13" @php echo (!empty($model) && $model->estate_type == 13 ? "selected" :'') @endphp>{{ l('زمین تجاری') }}</option>
                                        </optgroup>
                                        <optgroup label=l("پروژه‌های ساخت و ساز") id="sale3">
                                            <option value="14"  @php echo (!empty($model) && $model->estate_type == 14 ? "selected" :'') @endphp>{{ l('مشارکت در ساخت و ساز') }}</option>
                                            <option value="15"  @php echo (!empty($model) && $model->estate_type == 15 ? "selected" :'') @endphp>{{ l('پیش فروش') }}</option>
                                        </optgroup>
