...
@section('main_content')
    ...
    <main class="page-wrapper">
        ...
        <div class="bg-secondary mt-5 pt-2">
                ...
                <div class="row">
                    <div class="col-lg-4 pt-1 " >
                        <div class="row mb-3 py-4 border rounded-1 g-1 px-3 bg-white">
                            ...
                            <div class="col-lg-12 my-3 d-flex align-items-end justify-content-center">
                                <button class="btn btn-primary w-100" id="searchform">{{ l('جستجو') }}</button>
                            </div>
                        </div>
                    </div>
                    @endif
                    <div class="col-lg-8">
                        <div class="d-flex flex-sm-row flex-column align-items-sm-center align-items-stretch bg-white border rounded-1 py-3 px-4 mb-4">
                            ...
                            <div class="d-none d-sm-flex align-items-center flex-shrink-0 text-muted"><i class="fi-check-circle me-2"></i><span class="fs-sm mt-n1"><span id="totalCount">{{$usercount}}</span>{{ l('نتیجه یافت شد') }}</span>
                            </div>
...
<script type="text/javascript">
    ...
    function loadMoreData(page,str) {
        ...
        $.ajax({
            ...
            .done(function(data) {
                ...
                $("#agent-list-wrapper").html(data.html);
    ...
    $(document).ready(function() {
        var result = Paging(1, 20, {{$usercount}}, "myClass", "myDisableClass");
        $("#pagination").html(result);
        /*
