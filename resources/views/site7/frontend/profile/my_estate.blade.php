@extends(ss('THEME').'.frontend.layouts.intro.appnew_v2', [
    'title' => l('لیست املاک').($typelist == 'my')? l('من'):l('آژانس')
])
...
<link rel="stylesheet" media="screen" href="/vendor/tiny-slider/dist/tiny-slider.css" />
    ...
    <main class="page-wrapper">
        ...
        <div class="container mt-5 pt-3 p-0">
            <!-- Page content-->
            <div class="row">
                @include(ss('THEME') . '.frontend.layouts.sidebar', ['menu' => '2' , 'menutype'=>($typelist == 'my')?'agent':'branch'])
                <!-- Content-->
                ...
                <nav class="mb-3 pt-md-3" aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page"> لیست املاک {{($typelist == 'my')? l('من'):l('آژانس')}} </li>
                    </ol>
                </nav>
                <h3 class="mb-3"> لیست املاک {{($typelist == 'my')? l('من'):l('آژانس')}} </h3>
                <form  id="mySearch">
                ...
                <div class="card shadow-sm mb-4">
                    <div class=" card-body border-0  pb-1 me-lg-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-6 col-sm-12 mt-3 district">
                            ...
                            <div class="col-6 col-md-6 col-lg-2 col-sm-6 mt-3">
                                <label class="form-label" for="areamin">{{l('مساحت تا')}}</label>
                            ...
                            <div class="col-6 col-md-6 col-lg-2 col-sm-6 mt-3 not" access="11,12,13,14,15">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse border-top" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        <div class="row">
                                            ...
                                            <div class="col-6 col-md-6 col-lg-2 col-sm-6 mt-3 not" access="11,12,21,22">
                                            ...
                                            <div class="col-6 col-md-6 col-lg-2 col-sm-6 mt-3 not" access="11,21">
                                            ...
                                            <!--
                                            <div class="col-6 col-md-6 col-lg-2 col-sm-6 mt-3  not" access="11,12,21,22,23,13">
                                        ...
                                        @endif
                                            ...
                                            <div class="col-6 col-md-6 col-lg-2 col-sm-6 mt-3  not" access="11,12,13,15,21,22,23,25">
                                            ...
                                            <div class="col-6 col-md-6 col-lg-2 col-sm-6 mt-3 not" access="22">
