...
<main class="page-wrapper">
    ...
    <section class="container mt-lg-5">
        <div class="w-lg-75 mx-auto">
            <div class="d-flex">
                <div class="">
                    <h1 class="fs-4">{{ l('آژانس املاک املاک مشتری') }}</h1>
                    <p>{{ l('مشتری قدر مشتری داند') }}</p>
                </div>
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li class="nav-item">
                    <a href="#information" class="nav-link" data-bs-toggle="tab" role="tab">
                    {{ l('اطلاعات تماس') }}
                    </a>
                </li>
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="advertisements" role="tabpanel">
                ...
                <div class="tab-pane fade" id="about" role="tabpanel">
                    <div class="w-lg-50 mx-auto ">
                        <h4 class="fs-lg mb-4">{{ l('درباره آژانس') }}</h4>
                        <p class="">{{ l('قانون،مسئولیت و اخلاق سرلوحه ی کار ماست.') }}</p>
                        <ul class="px-2 ">
                            <li class="d-flex justify-content-between py-2 border-bottom">
                                <span class="opacity-60">{{ l('نوع آژانس') }}</span>
                                <span>{{ l('دپارتمانی') }}</span>
                            </li>
                            <li class="d-flex justify-content-between py-2 border-bottom">
                                <span class="opacity-60">{{ l('عضویت در دیوار') }}</span>
                                <span>{{ l('اردیبهشت 1400') }}</span>
                            </li>
                            <li class="d-flex justify-content-between py-2 border-bottom">
                                <span class="opacity-60">{{ l('تعداد آگهی های فعال آژانس') }}</span>
                                <span> 67 </span>
                            </li>
                            <li class="d-flex justify-content-between py-2 border-bottom">
                                <span class="opacity-60">{{ l('تعداد مشاوران') }}</span>
                                <span> 9 </span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="tab-pane fade" id="information" role="tabpanel">
                    <div class="w-lg-50 mx-auto ">
                        ...
                        <ul class="mb-4 px-2">
                            <li class="d-flex justify-content-between py-2 border-bottom">
                                <span class="opacity-60">{{ l('خط ثابت') }}</span>
                                <a href="#">02532886239</a>
                            </li>
                            <li class="d-flex justify-content-between py-2 border-bottom">
                                <span class="opacity-60">{{ l('ساعت کاری') }}</span>
                                <span>{{ l('8 صبح تا 10 شب') }}</span>
                            </li>
                            
                        </ul>
                        <h4 class="fs-lg mb-4">{{ l('آدرس') }}</h4>
                        <p>{{ l('قم 55 متری امام حسین خیابان پاسداران 6') }}</p>
                    </div>
                </div>            
            </div>
