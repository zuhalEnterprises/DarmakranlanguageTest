...
<main class="page-wrapper">
    ...
    <div class="container mt-5 pt-5 p-0" style="">
        <div class="row g-0 mt-n3">
            ...
            <!-- Page content-->
            <div class="main col-12 position-relative overflow-hidden pb-5 px-3" >
                <!-- Breadcrumb-->
                <nav class="my-3 pt-md-2 " aria-label="Breadcrumb">
                    <ol class="breadcrumb">
                ...
                <div class="w-100 w-lg-75 m-auto d-flex align-items-center bg-success rounded px-3 py-4 justify-content-around flex-column flex-lg-row mb-3 ">
                    <h1 class="text-center text-white fs-3">
                        {{ l('با عضویت در املاک یار کلبه ، به کسب و کارت رونق بده') }}
                    </h1>
    ...
    <div class="d-flex align-items-center justify-content-between mb-3 flex-column flex-lg-row">
      <a href="#" class="fs-5 mb-0 ">{{ l('همه املاک فروشی و اجاره ای در قم (2500 آگهی)') }}</a>
      <a href="#" class="fs-5 mb-0 ">{{ l('همه مشتریان خرید و اجاره ملک در قم (2500 آگهی)') }}</a>
