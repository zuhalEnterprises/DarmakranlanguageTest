@extends(ss('THEME').'.frontend.layouts.intro.appnew_v2', [
    'title' => !empty($model)? l('ویرایش آژانس') :l('ثبت آژانس جدید')
])
                ...
                <div class="col-lg-12 col-md-12 mb-5 account add-property">
                    ...
                    <nav class="mb-3 pt-md-3" aria-label="Breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">{{!empty($model)? l('ویرایش آژانس') :l('ثبت آژانس جدید')}}</li>
                        </ol>
                    </nav>
                        ...
                        <form  id="js_form_add_state" role="form"  method="POST" action="<?php if (!empty($model)) echo '/profile/branches/update/' . $model->id; else echo '/profile/branches/store'; ?>" enctype="multipart/form-data">
                            ...
                            <div class="mb-4 pb-2">
                                <div class="d-flex align-items-center flex-wrap flex-lg-nowrap gap-lg-3">
                                    <label for="name" class="form-label fw-bold w-100 w-lg-25">{{ l('نام آژانس') }}</label>
                                    <input class="form-control form-control-sm w-100 w-lg-75" type="text"  id="name" name="name"  value="{{!empty($model)?$model->name:''}}" required>
                                </div>
                                <div class="form-text">
                            ...
                            <div class="mb-4 pb-2">
                                <div class="d-flex align-items-center flex-wrap flex-lg-nowrap gap-lg-3">
                                    <label for="phone" class="form-label fw-bold w-100 w-lg-25">
                                         {{ l('شماره تلفن آژانس') }}
                                    </label>
                                    <input class="form-control form-control-sm w-100 w-lg-75" type="tel"  id="phone" name="phone" value="{{!empty($model)?$model->phone:''}}">
                                </div>
                                <div class="form-text">
                            ...
                            <div class="mb-4 pb-2">
                                <div class="d-flex align-items-center gap-3">
                                    <label for="type" class="form-label fw-bold w-50 w-lg-25">{{ l('نوع آژانس') }}</label>
                                    <select class="form-select form-select-sm w-50 w-lg-75" id="type" name="type">
                            ...
                            <div class="mb-4 pb-2">
                                ...
                                <div class="d-flex align-items-center gap-3 mb-4">
                                    <label for="province_id" class="form-label fw-bold w-50 w-lg-25">{{ l('استان') }}</label>
                                    <select class="form-select form-select-sm w-50 w-lg-75 select2"  name="province_id" id="province_id" >
                                        <option value="">{{ l('انتخاب کنید') }}</option>
                                ...
                                <div class="d-flex align-items-center gap-3 mb-4">
                                    ...
                                    <select class="form-select form-select-sm w-50 w-lg-75 select2"  name="city_id" id="city_id">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <label for="address" class="form-label fw-bold w-50 w-lg-25">{{ l('آدرس دفتر') }}</label>
                                    <textarea class="form-control form-select-sm w-50 w-lg-75" name="address" id="address">{{!empty($model)?$model->address:''}}</textarea>
                                </div>
                            </div>

                            <div class="mb-4 pb-2">
                                <div class="d-flex align-items-center flex-wrap flex-lg-nowrap gap-lg-3">
                                    <label for="districts" class="form-label fw-bold w-100 w-lg-25">{{ l('محل های فعالیت') }}</label>
                                    <select name="districts[]" class="form-select form-select-sm w-50 w-lg-75 select2 district_id" id="district_id"  multiple style="width: 100%">
                                        @if(isset($districts))
                            ...
                            <div class="mb-4 pb-2">
                                <div class="d-flex flex-wrap flex-lg-nowrap align-items-center gap-lg-3">
                                    <label for="comment" class="form-label fw-bold w-100 w-lg-25">{{ l('توضیحات') }}</label>
                                    <textarea class="form-control form-select-sm w-50 w-lg-75" name="comment" id="comment">{{ !empty($model) ? $model->comment : ''}}</textarea>
                                </div>
                            </div>
                                        ...
                                        if(!empty($model)){
                                            ...
                                            <div id="images" class=" card mb-3">
                                                ...
                                                <div class="card-body align-content-center align-items-center d-flex flex-row flex-wrap justify-content-around">
                                                    @foreach($model->images->where("360","=",0)->where("plan","=",0)->where("hidden","=",0) as $item)
                            ...
                            @endif
                            <div>
                                <button class="btn btn-primary w-100 w-lg-auto">{{!empty($model)? l('ویرایش آژانس') :l('ثبت آژانس')}}</button>
                            </div>
