...
<div class="col-md-6 col-lg-3 col-sm-6 mt-3">
        <label  class=" fw-bold" for="purchase_priority">{{ l('میزان تعجیل') }}</label>
...
<div class="col-md-6 col-lg-3 col-sm-6 mt-3 d-none max_room_count1">
...
<div class="col-md-6 col-lg-3 col-sm-6 mt-3 d-none max_unit_in_floor1">

        <label  class="fw-bold" for="max_unit_in_floor">{{ l('حداکثر واحد در طبقه') }}</label>
...
<div class="col-md-6 col-lg-3 col-sm-6 mt-3 d-none max_building_age1">
...
<div class="col-md-6 col-lg-3 col-sm-6 mt-3 d-none floor_count1">
...
<div class="col-md-6 col-lg-3 col-sm-6 mt-3 d-none min_floor_count1">
...
<div class="col-md-6 col-lg-3 col-sm-6 mt-3 d-none floor_start1">
...
<div class="col-md-6 col-lg-3 col-sm-6 mt-3 d-none min_floor_area1">

        <label class="fw-bold" for="min_floor_area">{{ l('حداقل متراژ زمین') }}</label>
        <input class="form-control" type="number"  id="min_floor_area" name="min_floor_area" >
</div>

<div class="col-md-6 col-lg-3 col-sm-6 mt-3 d-none min_front_area1">
...
<div class="col-md-6 col-lg-3 col-sm-6 mt-3 d-none min_street_width1">
...
<div class="col-md-6 col-lg-3 col-sm-6 mt-3 d-none min_density1">
...
<div class="col-md-6 col-lg-3 col-sm-6 mt-3 d-none geography1">
...
<div class="col-md-6 col-lg-3 col-sm-6 mt-3 d-none build_license1">
  ...
  <div class="col-md-6 col-lg-3 col-sm-6 mt-5 d-none ">
...
<div class="col-md-6 col-lg-3 col-sm-6 mt-5">
