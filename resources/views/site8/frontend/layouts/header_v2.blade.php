...
<header class="navbar navbar-expand-lg navbar-light  fixed-top pt-lg-0 flex-column" data-scroll-header>
            ...
            <div class="container">
                <div class="d-flex align-items-center justify-content-between gap-2 py-2">
                    <div class="d-flex gap-5">
                        <a href="/cities" class="text-dark d-flex gap-2 align-items-center fs-sm">
                            <span><i class="fi-billboard-house"></i></span>
                            <span>{{ l('املاک خرید و فروش') }}</span>
                        </a>
                    ...
                    <ul class="nav flex-row  gap-3">
                        ...
                        <li class="nav-item mt-1 fs-5 ">
                            <a class=""  href="tel:09128536602">
                                        09128536602
                            </a>
                        </li>
                        <li class="nav-item mb-2 fs-5 ">
                            <a class="nav-link p-0 fw-normal opacity-80 text-accent" aria-label="instagram" href="https://www.instagram.com/mehrara6602">
                                <i class="fi-instagram"></i>
                            </a>
                        </li>

                        <li class="nav-item mb-2 fs-5">
                            <a class="nav-link p-0 fw-normal opacity-80" rel="nofollow" aria-label="youtube" href="https://eitaa.com/shmarkazi" style="width: 21px;">
    ...
    <div class="container gap-1 pt-2 pb-3" style="margin-top: 0 !important;">

        <div class="d-flex flex-column flex-lg-row align-items-center">
            <a href="/" class="navbar-brand m-0 ms-xl-4 logo" >
                <img src="/img/site8/logo-markazi.png" style="height: 50px" alt="{{ss('SITE_NAME')}}">
            </a>
            <a href="/" class="navbar-brand m-0 ms-xl-4 logo logo-name" style="color:#481C08">
                {{ss('SITE_NAME')}}
            </a>
        </div>
        ...
        <a class="btn btn-primary d-lg-none order-lg-3" href="/login">
            <i class="fi-user me-2"></i>{{ l('ورود/ثبت نام') }}
        </a>
        ...
        @if(empty($currentUser))
        <a class="btn btn-sm btn-primary  d-none d-lg-block order-lg-3" href="/login">
            <i class="fi-user me-2"></i>{{ l('ورود/ثبت نام') }}
        </a>
        @else
                            <div class="dropdown">
