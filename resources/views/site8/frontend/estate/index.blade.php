    ...
    <main class="page-wrapper">
        ...
        <div class="container mt-5 pt-5 p-0" style="">
            <div class="row g-0 mt-n3">
                    ...
                    <div class="offcanvas offcanvas-start offcanvas-collapse" id="filters-sidebar">
                        ...
                        <div class="offcanvas-body py-lg-4">
                            <div class="pb-4 mb-2">
                                ...
                                placeholder =l("عبارت جستجو")
                                name="title" class="form-control" onchange="checkSend()">
                            </div>
                            <div class="pb-4 mb-2">
                                <input type="text" id="estate_id"
                                placeholder =l("کد ملک")
                                name="estate_id" class="form-control" onchange="checkSend()">
                            </div>
                            <div class="pb-4 mb-2">
                                ...
                                <div class="d-flex justify-content-between align-items-start gap-1">
                                    <div style="border:1px solid #d5d2dc" class="rounded-1 text-center px-18px ">
                                        <button selected style="border:0px;background:white" class="flex items-center justify-between w-full h-59px js_min_button js_min_Price js_button">
                                            ...
                                            <input type="text" id="minPrice1" placeholder="{{l('حداقل خرید')}} " name="minPrice1" style="border:0px;background:white" class="text-gray-400 font-light w-full outline-0 text-center js_min_max_input js_price input-price">
                                        </button>
                                ...
                                <div class="d-flex justify-content-between align-items-start gap-1">
                                    ...
                                    <div style="border:1px solid #d5d2dc" class="rounded-1 text-center px-18px ">
                                        <button selected style="border:0px;background:white" class="flex items-center justify-between w-full h-59px js_max_button js_max_Price js_button">
                                            ...
                                            <input type="text" name="maxPrice1" id="maxPrice1" placeholder="{{l('حداکثر خرید')}} " style="border:0px;background:white" class="text-gray-400 font-light w-full outline-0 text-center js_min_max_input js_price input-price">
                            ...
                            <div class="pb-4 mb-2">
                                <div class="d-flex align-items-center gap-1">
                                    <input class="form-control w-100" type="tel" min="1" max="5000"
                                        step="1" placeholder="{{l('حداقل مساحت')}}" id="minarea" onchange="checkSend()">
                                    <input class="form-control w-100" type="tel" min="1" max="5000"
                                        step="1" placeholder="{{l('حداکثر مساحت')}}" id="maxarea" onchange="checkSend()">
                                </div>
                            </div>
                            @if(env('COUNTRY') != 'UAE')
                            <div class="pb-4 mb-2">
                                <select class="form-select" id="built_year" name="built_year"  onchange="checkSend()">
                                    <option value="" selected>{{ l('عمربنا') }}</option>
                            ...
                            <div class="pb-4 mb-2">
                                ...
                                <div class="d-flex align-items-center gap-1">
                                    <input class="form-control w-100 text-center" type="tel" min="1" max="5000"
                                        step="1" placeholder="{{l('حداقل طبقه')}}" id="minfloorcount" onchange="checkSend()">
                                    <input class="form-control w-100 text-center" type="tel" min="1" max="5000"
                                        step="1" placeholder="{{l('حداکثر طبقه')}}" id="maxfloorcount" onchange="checkSend()">
                                </div>
                            </div>
                                ...
                                <div class="pb-4 mb-2">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <select class="form-select" id="unit_in_floor" onchange="checkSend()" name="unit_in_floor" >
                                            <option value="" selected>{{l('حداکثر تعداد واحد در طبقه')}} </option>
                                ...
                                <div class="pb-4 mb-2">
                                <label class="d-block pt-2 my-1 h6">{{l(' حداقل اتاق')}}</label>
                            ...
                            <div class="pb-4 mb-2">
                                <select class="form-select" id="geography" name="geography" onchange="checkSend()">
                                    <option value="" selected>{{ l('موقعیت جغرافیایی') }}</option>
                ...
                <!-- Page content-->
                <div class="main col-lg-9 col-xl-9 position-relative overflow-hidden pb-5 pt-4 px-3 mt-4"
